(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".nav__icon")) document.addEventListener("click", (function(e) {
        ...
        class SelectConstructor {
            ...
            selectsActions(e) {
                ...
                if (targetElement.closest(this.getSelectClass(this.selectClasses.classSelect)) || targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag))) {
                    const selectItem = targetElement.closest(".select-main") ? targetElement.closest(".select-main") : document.querySelector(`.${this.selectClasses.classSelect}[data-id="${targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag)).dataset.selectId}"]`);
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const aboutUsGalerySlider = document.querySelector(".about-us__slider");
            let rentalSwiper;
            let askedSwiper;
            let fractionSwiper;
            let aboutUsSwiper;
            function initSliders() {
                if (window.innerWidth <= 767.98) {
                    ...
                    if (aboutUsGalerySlider && !aboutUsSwiper) aboutUsSwiper = new core(".about-us__slider", {
                        modules: [ Pagination ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
